...
class TestPIDSystemTime(unittest.TestCase):
    ...
    def setUp(self):
        ...
        logging.info(
            "Setup: PID controller initialized with kp=1.0, ki=0.1, kd=0.01, intMax=100.0, intMin=-100.0"
        )
    ...
    def test_initialization(self):
        ...
        logging.debug(
            f"PID controller initialized: kp={self.pid.kp}, ki={self.pid.ki}, kd={self.pid.kd}, intMax={self.pid._PID__intMax}, intMin={self.pid._PID__intMin}"
        )
